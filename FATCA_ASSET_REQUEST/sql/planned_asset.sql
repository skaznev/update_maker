declare
 i_rep_date       date := :v_rep_date; -- Дата отчета
 i_payment_date   date := :v_pay_rep_date; -- Дата выплаты
 i_last_rep_date  date := :v_last_rep_date; -- Последний день приема
 ...
 begin
      ...
      :v_clob := TR_W_REPORT_FATCA_ASSET.GET_PLANNED_ASSET_XML( i_inq_id );
