...
#     i_list = os.scandir()   #glob.glob('*.TXT')
#     print(i_list)
#     #file.write()
...
# import os
# for root, dirs, files in os.walk(os.path.join(root, "files")):
#     for file in files:
#         if file.endswith(".TXT"):
#              print(os.path.join(root, file))

# import glob, os
# os.chdir(r"C:\python\projects\test_programms\find_and_math_files\files")
# for file in glob.glob("*.TXT"):
#     print(file)


import os
with open('METHOD_TYPE.TXT', 'w', encoding = "windows-1251") as file2:
    for root, dirs, files in os.walk(r"C:\python\projects\test_programms\find_and_math_files\files"):
        for file in files:
            if file.endswith("METHOD_TYPE.TXT"):
                print(os.path.join(root, file))            
                s = open(os.path.join(root, file),'r', encoding = "windows-1251")
                for line in s:
                    print(line)
                    file2.write(line)    
